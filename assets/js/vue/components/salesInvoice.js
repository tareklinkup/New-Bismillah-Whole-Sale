            ...
            if (this.currentBranch.print_type == '4') {
                ...
                <body>
                    <div class="row">
                        ...
                        height: 55px;
                        width: 80px;
                        position: relative;"><img style="width: 100%;height: 100%;position: absolute;" src="/uploads/company_profile_thum/${this.currentBranch.Company_Logo_org}" alt="Logo" style="height:80px;" /></div>
                    ...
                    <html>
                        ...
                        <body>
                            <div style="text-align:center;">
                                ...
                                <strong style="font-size:19px;">${this.currentBranch.Company_Name}</strong><br>
                                <p style="white-space:pre-line;">${this.currentBranch.Repot_Heading}</p>
                            </div>
                            ${invoiceContent}
                        </body>
