            ...
            <div class="col-md-5">
                ...
                <div class="form-group clearfix">
                    ...
                    <div class="col-md-7">
                        ...
                        <v-select v-bind:options="districts" v-model="selectedDistrict" label="District_Name"
                            v-if="districts.length > 0"></v-select>
                    </div>
                    <div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/area" target="_blank"
            ...
            <div class="col-md-5">
                ...
                <div class="form-group clearfix">
                    ...
                    <div class="col-md-7">
                        ...
                        <input type="radio" name="customerType" value="wholesale" v-model="customer.Customer_Type">
                        Wholesale
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-sm-12 form-inline">
            <div class="form-group">
                ...
                <input type="text" class="form-control" v-model="filter" @input='onChangeFilter' placeholder="Filter">
            </div>
        </div>
        <div class="col-md-12">
            <div class="table-responsive">
                <datatable :columns="columns" :data="customers" style="margin-bottom: 5px;">
                    <template scope="{ row }">
                        <tr>
    ...
    computed: {
        customers(array, value) {
            if (this.searchValue == "") {
                ...
                return this.customers2.filter((data) => data.Customer_Name.toLowerCase().startsWith(this
                    .searchValue));
            }
        }
    },
