						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								<div class="form-group">
									...
									<div class="col-xs-7">
										<v-select v-bind:options="products" id="product" v-model="selectedProduct" label="display_text" v-on:search="searchProduct" v-on:input="onChangeProduct"></v-select>
									</div>
									<div class="col-xs-1" style="padding: 0;">
								...
								<div class="form-group">
									...
									<div class="col-xs-3">
										<input type="text" id="purchaseRate" name="purchaseRate" class="form-control" placeholder="Pur. Rate" v-model="selectedProduct.Product_Purchase_Rate" v-on:input="productTotal" />
									</div>
	...
	new Vue({
		...
		methods: {
			...
			addToCart() {
				...
				if (this.selectedProduct.quantity == null) {
